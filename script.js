...
myCPS();
//labels
document.getElementById("label1").innerHTML = "Smurfcats: ";
document.getElementById("label2").innerHTML = "Smurfcats per Click: ";
document.getElementById("label3").innerHTML = "Smurfcats per Second: ";
